...
/**
 * GET /api/state-admin/my-direct-referrals?refer_code=SAT12345
 * 
 * Fetches customers who were directly referred by this state admin
 * Shows their orders and commissions earned (100% Commission Model)
 */
    ...
    try {
        ...
        if (!referCode) {
            return NextResponse.json(
                { success: false, error: 'State admin referral code required' },
                { status: 400 }
            );
        }
        ...
        // 1. Get all customers who used this referral code
        ...
        // Initialize with all referred customers
        ...
        const stats = {
            ...
            pending_commissions: ordersResult.rows
        ...
        console.error('Failed to fetch state admin direct referrals:', error);
        return NextResponse.json(
            {
                success: false,
