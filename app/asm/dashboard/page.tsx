                                        ...
                                        <div className="flex items-center justify-between gap-3">
                                            <div className="flex items-center gap-2 min-w-0">
                                                {campaign.product_thumbnail ? (
                                                    ...
                                                    <img src={campaign.product_thumbnail} alt={campaign.product_name || campaign.product_id} className="w-10 h-10 rounded object-cover border border-blue-200 shrink-0" />
                                                ) : (
                                            ...
                                            <span className="text-sm font-bold text-blue-700 shrink-0">+{Number(campaign.additional_rate || 0).toFixed(2)}%</span>
                                        </div>
