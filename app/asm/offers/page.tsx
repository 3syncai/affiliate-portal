        ...
        {isLoading ? (
          ...
          <div className="p-4 space-y-3">
            {campaigns.map((campaign) => (
              <div key={campaign.id} className="rounded-lg border border-blue-100 bg-blue-50 px-4 py-3">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="text-lg font-bold text-blue-700">+{Number(campaign.additional_rate || 0).toFixed(2)}%</span>
                </div>
              </div>
            ))}
          </div>
