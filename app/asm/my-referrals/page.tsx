    ...
    return (
        <div className="space-y-4 sm:space-y-6 min-w-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className={`self-start sm:self-auto flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium shrink-0 ${isConnected ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-7 gap-3 sm:gap-4">
                ...
                <Link href="/asm/returns" className="block min-w-0">
                    <StatCard
                        ...
                        iconBg="bg-rose-50"
                        hoverClass="hover:border-rose-200 cursor-pointer transition-colors h-full"
                    />
                </Link>
                <StatCard
                    label="Total Sales"
                                ...
                                <div key={customer.customer_id} className="p-4 min-w-0">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 mt-3 text-xs">
                                        <div>
                                            ...
                                            <p className="text-gray-700">{formatDate(customer.joined_at)}</p>
                                        </div>
                                        <div>
                                            <p className="text-[10px] uppercase text-gray-400 font-semibold">First Order</p>
                                            <p className="text-gray-700">{formatDate(customer.first_order_at)}</p>
                                        </div>
                                        <div>
...
function StatCard({
    ...
    return (
        <div className={`bg-white rounded-xl border border-gray-200 p-3 sm:p-5 shadow-sm min-w-0 ${hoverClass}`}>
