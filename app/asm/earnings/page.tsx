...
import { DollarSign, TrendingUp, ShoppingBag, MapPin, AlertCircle, Wallet, ArrowDownCircle, ArrowUpCircle, CreditCard, ChevronRight, Calendar, User } from "lucide-react"
        ...
        <div className="space-y-8 max-w-[1600px] mx-auto p-2">
            ...
            <div>
                ...
                <p className="text-gray-500 mt-1 flex items-center gap-2 text-sm">
                    ...
                    Earnings from <span className="font-medium text-gray-900">{userData?.city}, {userData?.state}</span>
                </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-[#0f172a] text-white shadow-xl">
                ...
                <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[500px] h-[500px] rounded-full bg-blue-500/10 blur-3xl"></div>
                <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-[300px] h-[300px] rounded-full bg-emerald-500/10 blur-3xl"></div>

                <div className="relative p-8 md:p-10">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div>
                            <p className="text-blue-200/80 font-medium text-sm tracking-wide uppercase mb-1">Total Available Balance</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow group">
                    ...
                    <div className="mt-3 text-xs text-gray-400">
                        Completed orders in {userData?.city}
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow group">
                    ...
                    <p className="text-gray-500 text-sm font-medium">Affiliate Commissions</p>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-0.5">Orders generating commission in your area</p>
                    </div>
                </div>
                ...
                {recentOrders.length === 0 ? (
                    <div className="p-16 text-center">
                        ...
                        <p className="text-gray-500 text-sm">Orders from your area will appear here.</p>
                    </div>
                ) : (
            ...
            <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div className="text-sm text-blue-900">
                    ...
                    <p className="opacity-90">
                        Earnings are calculated as <strong>{stats.commissionRate}%</strong> of the total branch admin commissions generated in <strong>{userData?.city}</strong>. This is a cascading commission structure (Affiliate → Branch → ASM).
                    </p>
                </div>
            </div>
        </div>
