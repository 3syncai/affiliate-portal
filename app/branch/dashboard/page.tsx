              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div className="p-3 rounded-lg bg-emerald-50 border border-emerald-100">
                    ...
                    <p className="text-emerald-600/80 text-[10px] uppercase font-semibold tracking-wide">
                      Direct Sales
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-blue-50 border border-blue-100">
                    ...
                    <p className="text-blue-600/80 text-[10px] uppercase font-semibold tracking-wide">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              {additionalLoading ? (
                ...
                <p className="text-xs text-gray-500">
                  No active additional commission offers for ASM.
                </p>
              ) : (
