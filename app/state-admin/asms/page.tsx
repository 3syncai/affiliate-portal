    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 min-w-0">
          <p className="text-xs sm:text-sm text-gray-500">Total ASM&apos;s</p>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-3">
                  <div className="min-w-0">
                    ...
                    <p className="truncate">{asm.phone || "-"}</p>
                  </div>
                  <div className="min-w-0">
                    <p className="uppercase tracking-wide text-[10px] text-gray-400 font-semibold">
                      Branch
                    </p>
                    <p className="truncate">{asm.branch}</p>
                  </div>
                  <div className="min-w-0">
                    <p className="uppercase tracking-wide text-[10px] text-gray-400 font-semibold">
                      City
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="truncate">{asm.state}</p>
                  </div>
