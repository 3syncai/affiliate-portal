...
export default function StateAdminProductsPage() {
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Direct sales earn you maximum commission (~{Math.round(commissionRate)}%)</p>
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all bg-white"
                    />
                </div>
