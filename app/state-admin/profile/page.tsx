...
export default function StateAdminProfilePage() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6 min-w-0">
            ...
            <div className="min-w-0">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">State Admin Profile</h1>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="p-4 sm:p-6">
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3">
                                        <div className="relative flex-1">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-16 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-gray-900"
                                            />
                                        </div>
                                        <button
                                            type="button"
                                    ...
                                    {phoneSuccess && (
                                        <p className="text-sm text-emerald-600 mt-2">{phoneSuccess}</p>
                                    )}
                                </div>
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <p className="text-sm text-blue-800">
                                    <strong>Note:</strong> You can update your mobile number here. For name, email, or state changes, contact the system administrator.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    {/* KYC & Bank Tab */}
                    {activeTab === 'kyc' && (
                        <SubAdminKycBankSection apiBase="/api/state-admin/me" themePrimary={theme.primary} />
                    )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                    ...
                    <div className="text-lg font-semibold text-gray-900 mt-1">State Administrator</div>
                </div>
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                    ...
                    <div className="text-lg font-semibold text-gray-900 mt-1">{user?.state || '-'}</div>
                </div>
            </div>
        </div>
    )
