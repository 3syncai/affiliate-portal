...
import { Users, TrendingUp, DollarSign, ShoppingBag, Search, ArrowRight, Package, Clock, Wifi, WifiOff } from "lucide-react"
...
export default function MyDirectReferralsPage() {
    ...
    const { data, mutate, isLoading } = useSWR(
        user?.refer_code ? `/api/state-admin/my-direct-referrals?refer_code=${user.refer_code}` : null,
        fetcher
    )
    ...
    const handleUpdate = useCallback((data: any) => {
        if (data.type === 'new_direct_referral' || data.type === 'commission_update') {
            setToastData({
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        Customers you referred directly • <span className="text-emerald-600 font-bold">~100% Commission Rate</span>
                    </p>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-amber-600 mt-1">
                                {loading ? "..." : `₹${stats.pending_commissions?.toLocaleString("en-IN") || '0'}`}
                            </p>
                        </div>
                    ...
                    <div className="text-center py-16">
                        ...
                        <p className="text-gray-500 text-sm">
                            {searchTerm
                                ...
                                : "Start sharing your referral code to earn 100% commission"}
                        </p>
                    </div>
                ) : (
                                ...
                                {selectedCustomer.orders.map((order) => (
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                <p className="text-xs text-gray-500">Commission (100%)</p>
