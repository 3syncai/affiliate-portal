...
import { Users, TrendingUp, DollarSign, ShoppingBag, Search, ArrowRight, Package, Clock } from "lucide-react"
...
export default function MyDirectReferralsPage() {
    ...
    const fetchDirectReferrals = async (referCode: string) => {
        try {
            const response = await axios.get(`/api/state-admin/my-direct-referrals?refer_code=${referCode}`)
