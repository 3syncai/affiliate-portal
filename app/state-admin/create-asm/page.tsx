    ...
    return (
        <div className="space-y-4 sm:space-y-6 min-w-0">
            <div className="min-w-0">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Create Branch Manager</h1>
                <p className="text-gray-600 mt-1 text-sm sm:text-base">Create a new branch manager for {stateAdminState}</p>
            </div>
