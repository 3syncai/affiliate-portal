...
export default function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-[950] w-[95%] max-w-md -translate-x-1/2 rounded-xl border border-slate-200 bg-white/95 shadow-lg backdrop-blur-md">
